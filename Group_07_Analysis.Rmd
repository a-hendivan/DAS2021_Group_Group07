...
>>>>>>> eb5bbc0cee338f2810a7be5cfd68ffc829017061
Given the output of the full model and plotting the estimates as shown in Figure \ref{fig:fullmodelCI} shows that the coefficient for year has an estimate of`r exp(coefficients(full_model)["year"])` with 95\% confidence interval `r exp(confint(full_model)["year",])`, which contains 1 and that indicates that the variable year is not a significant predictor for the odds ratio of getting rate over 7, thus we drop it from the model.
